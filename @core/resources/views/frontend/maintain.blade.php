...
<script>
    $(document).ready(function (){
        ...
        $(document).on('click', '.newsletter-form-wrap .submit-btn', function (e) {
            ...
            var el = $('.newsletter-form-wrap .submit-btn i');
            
            newsCont.html('');
            el.addClass('fa-spin fa-spinner').removeClass('fa-paper-plane');
            ...
            $.ajax({
                ...
                success: function (data) {
                    newsCont.html('<div class="alert alert-'+data.type+'">' + data.msg + '</div>');
                     el.removeClass('fa-spin fa-spinner').addClass('fa-paper-plane');
                },
                error: function (data) {
