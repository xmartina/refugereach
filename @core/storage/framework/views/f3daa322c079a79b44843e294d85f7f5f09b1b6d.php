...
<?php endif; ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Create Donation Gift')); ?></h4>
                        ...
                        <form action="<?php echo e(route('admin.donations.gift.store')); ?>" method="post">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/fundorex/@core/resources/views/backend/donations/gifts/gift-create.blade.php ENDPATH**/ ?>