...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title> <?php echo e(__('Tax Certificate')); ?> </title>
    ...
    <div class="invoice-wrapper">
        <div class="invoice-header">
            ...
            <div class="invoice-flex-contents">
                ...
                <div class="company_details"style="float:right; padding-top: 0">
                    <ul>
                        <li><?php echo e(get_static_option('company_name')); ?></li>
                        <li><small><?php echo e(get_static_option('company_address')); ?></small></li>
                        <li><small><?php echo e(get_static_option('company_contact')); ?></small></li>
                        <li><small>Date : <?php echo e(date('d M, Y', strtotime($certificate_date))); ?></small></li>
                    </ul>
                </div>
           ...
           <div class="invoice-header-contents">
               <h2 class="invoice-title"><?php echo e($tax_title); ?> </h2>
           </div>

           <div class="item-description">
               <p><?php echo e($tax_description); ?></p>
           </div>



        <div class="item-description">
            <h5 class="table-title"><?php echo e(__('Your Transaction Details')); ?></h5>
            <table class="custom--table">
                ...
                <tbody>
                <?php $__currentLoopData = $donation_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($data->name); ?></td>
                    <td><?php echo e(date('d-m-Y',strtotime($data->created_at))); ?></td>
                    <td><?php echo e($data->cause_id); ?></td>
        ...
        <div class="seller_admin_notes_wrapper">
                ...
                <div class="seller_admin_notes">
                    ...
                    <p><?php echo e($tax_note); ?></p>
                </div>

            <div class="seller_admin_notes signature_image">
                <h6><?php echo e(__('Signature : ')); ?></h6><br>

                <div class="signature">
                    <?php echo render_image_markup_by_attachment_id(get_static_option('company_signature_image')); ?><br>
                </div>

                <span class="signature_underline"><?php echo e(__('_______________')); ?></span>
            </div>
