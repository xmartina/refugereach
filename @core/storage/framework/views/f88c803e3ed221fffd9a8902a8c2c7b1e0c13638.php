...
<?php $__env->startSection('section'); ?>
  <div class="card">
      <div class="card-body">
          <h5 class="modal-title"><?php echo e(__('Edit Cause Gift')); ?>

              <a class="btn btn-success pull-right btn-sm" href="<?php echo e(route('user.campaign.gift.all')); ?>"><?php echo e(__('Go Back')); ?></a>
          </h5>

          <form action="<?php echo e(route('user.campaign.gift.update')); ?>" method="post">
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/fundorex-last-file/@core/resources/views/frontend/user/dashboard/campaigns/cause-gifts/edit-gift.blade.php ENDPATH**/ ?>