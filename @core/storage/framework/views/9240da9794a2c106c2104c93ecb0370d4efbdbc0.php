                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.blog.new')); ?>" method="post" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input id="title" type="text" class="form-control" name="title" value="<?php echo e(old('title')); ?>" placeholder="<?php echo e(__('Title')); ?>">
                            </div>
                            ...
                            <div class="form-group permalink_label">
                                <label class="text-dark"><?php echo e(__('Permalink / Slug * : ')); ?>
                                    ...
                                    <span id="slug_edit" class="display-inline">
                                        ...
                                        <input type="text" name="slug" value="<?php echo e(old('slug')); ?>" class="form-control blog_slug mt-2" style="display: none">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control"  value="<?php echo e(old('author')); ?>" name="author">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="title"><?php echo e(__('Blog Tags')); ?></label>
                                    <input type="text" class="form-control" value="<?php echo e(old('tags')); ?>" name="tags"
                                           data-role="tagsinput">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="excerpt" id="excerpt"  class="form-control max-height-150" cols="30" rows="10"><?php echo e(old('excerpt')); ?></textarea>
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/fundorex/@core/resources/views/backend/blog/new.blade.php ENDPATH**/ ?>