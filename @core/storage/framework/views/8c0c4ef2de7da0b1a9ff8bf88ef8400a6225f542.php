                ...
                <tbody>
                  ...
                  <?php $__currentLoopData = $withdraw_logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <ul>
                                <li><strong><?php echo e(__("Cause")); ?>:</strong> <?php echo e(optional($data->cause)->title); ?></li>
            ...
            $.ajax({
               ...
               success: function (data){
                   ...
                   if (data.available_amount > 0){
                       ...
                       modalForm.find('#withdraw_able_amount_wrap').html('<p class="text-success text-capitalize"><?php echo e(__('withdraw able balance')); ?> '+data.available_amount+'<?php echo e(get_static_option('site_global_currency')); ?></p>');
                   }else{
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/fundorex-last-file/@core/resources/views/frontend/user/dashboard/campaigns/campaign-log-withdraw.blade.php ENDPATH**/ ?>