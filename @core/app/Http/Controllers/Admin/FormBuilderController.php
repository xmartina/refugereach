...
class FormBuilderController extends Controller
{
    ...
    public function update_get_in_touch_form(Request $request){
        $this->validate($request,[
            'field_name' => 'nullable|max:191',
            'field_placeholder' => 'nullable|max:191',
        ]);
    ...
    public function donation_form_index(){
        return view('backend.form-builder.donation-form');

    }
    public function update_donation_form(Request $request){
        $this->validate($request,[
            'field_name' => 'required|max:191',
            'field_placeholder' => 'required|max:191',
        ]);
        update_static_option('donation_page_form_fields',FormBuilderHelpers::filter_form_field($request));
